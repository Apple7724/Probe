# это программа нормирования данных
# индекс каждого элемента это элемент деленный на масштаб
# (значение элемента деленное на среднее значение)
data = [
...
for i in range(len(data)):
    index = data[i][1] / emojixpress_mean + data[i][2] / instagram_mean + data[i][3] / twitter_mean
    data[i].append(index)

...
add_roi(oscar_data)
add_price_per_minute(oscar_data)# < напишите код здесь >

genres_means = []
for genre in selected_genres:
    # отфильтруйте таблицу по жанру
    filtered_data = filter_by_genre(oscar_data, genre)# < напишите код здесь >
    
    # посчитайте средние значения по отфильтрованной таблице

    # средняя оценка (индекс столбца 2)
    mean_score = column_mean(filtered_data, 2)# < напишите код здесь >
        
    # средняя длина (индекс столбца 3)
    mean_length = column_mean(filtered_data, 3)# < напишите код здесь >

    # среднее значение ROI (индекс столбца 7)
    mean_roi = column_mean(filtered_data, 7)# < напишите код здесь >

    # средняя цена за минуту (индекс столбца 8)
    mean_ppm = column_mean(filtered_data, 8)# < напишите код здесь >
